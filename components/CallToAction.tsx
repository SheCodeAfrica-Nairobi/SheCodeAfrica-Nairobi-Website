  ...
  return (
    <div className="md:mx-[100px] my-[100px] bg-primary bg-opacity-10 h-auto w-auto md:h-[446px] px-20 py-10">
      <div className="flex justify-between leading-loose items-center">
        ...
        <button
          className="border-primary text-primary border-2 rounded-full 
                    px-6 py-2"
        >
          Be a member
        </button>
      </div>
      <div className="flex py-10 mx-auto space-x-3 md:space-x-6 lg:space-x-10 h-auto">
        {/* Value 1 */}
        <div className="space-y-4 text-darkAccent w-auto">
